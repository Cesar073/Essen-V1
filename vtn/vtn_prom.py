...
class Ui_VtnaCombos(object):
    def setupUi(self, VtnaCombos):
        ...
        icon3 = QIcon()
        icon3.addFile(u"./icon/goma.png", QSize(), QIcon.Normal, QIcon.On)
        self.push_Borrar.setIcon(icon3)
...
"border-color: rgb(95, 95, 95);")
        ...
        icon4 = QIcon()
        icon4.addFile(u"./icon/pngocean.com.png", QSize(), QIcon.Normal, QIcon.On)
        self.push_Regalo.setIcon(icon4)
...
"border-color: rgb(95, 95, 95);")
        ...
        icon5 = QIcon()
        icon5.addFile(u"./icon/cambiar.png", QSize(), QIcon.Normal, QIcon.On)
        self.push_Cprecio.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u"./icon/descuento2.png", QSize(), QIcon.Normal, QIcon.On)
        self.push_Descuento.setIcon(icon6)
...
"border-color: rgb(95, 95, 95);")
        ...
        icon7 = QIcon()
        icon7.addFile(u"./icon/buscarlupa.png", QSize(), QIcon.Normal, QIcon.On)
        self.push_Bproduc.setIcon(icon7)
...
"border-color: rgb(95, 95, 95);")
        ...
        icon8 = QIcon()
        icon8.addFile(u"./icon/camioncito.png", QSize(), QIcon.Normal, QIcon.On)
        self.push_Agregar_Envio.setIcon(icon8)
